...
# This file was *autogenerated* from the file SPIDER_IBS.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_1024p0 = RealNumber('1024.0')
import sys
import time
...
class parameters_IBS(SPIDER_pp):
    ...
    def __init__(self):
        super().__init__(q=_sage_const_1 ,level=_sage_const_1 ,r=_sage_const_1 )

    def H_prism(self,id,mpk,r=None):
        a=self.a/_sage_const_2 
...
def KeyDer(pp,mpk,msk,id):
    ...
    E_prim.set_order((p+_sage_const_1  )**_sage_const_2  , num_checks=_sage_const_0  )
...
def verify_IBS(pp,mpk,id,msg,sig):
    ...
    q,_=pp.H_prism(id,mpk,r=sig[_sage_const_1 ])
    if pp.q!=q: pp.set_q(q)
    v=SPIDER_vrify(pp,mpk,msg,sig[_sage_const_0 ])
    return v
...
print(f'signature size: {(sys.getsizeof(sig[_sage_const_0 ])+ sum(sys.getsizeof(s) for s in sig[_sage_const_0 ])+sys.getsizeof(sig[_sage_const_1 ]))/_sage_const_1024p0 : .2f} KB')
